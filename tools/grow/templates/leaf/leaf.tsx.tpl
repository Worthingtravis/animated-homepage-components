/**
 * __LEAF_TITLE__ — a leaf on __TREE_TITLE__ / __BRANCH_TITLE__.
 *
 * PURE PRESENTATION. Its props ARE __VM_TYPE__.
...
export const meta: LeafMeta = {
  label: "__LEAF_TITLE__",
  description: "TODO: describe this leaf's look in one line.",
  sizeHint: "md",
  tags: [],
};

export function __LEAF_EXPORT__(vm: __VM_TYPE__) {
...
export default __LEAF_EXPORT__;
